...
export const testimonials = [
  {
    id: 1,
    name: 'Guest testimonial placeholder',
    title: 'To be replaced by hotel management',
    text: 'Verified guest testimonial copy will be added here by Golden Gates Hotel management.',
    rating: 5,
    initials: 'GG',
  },
  {
